...
task("interactWithContract", "Interact with the deployed contract").setAction(
    async () => {
        // 1. 配置你的以太坊网络提供者，这里使用了 Infura 作为例子
